export default function uiAlertError() {
  const d = document;
  d.querySelector('#message').remove();
  d.querySelector('#content').remove();

  const section = d.createElement('section');
  section.id = 'alert';
  section.classList.add('alert', 'fade-in');
  section.innerHTML = `
    <div class="alert__text">
      ...
      <p>
        Hubo un error al obtener la lista de recursos, vuelva a intentar por
        favor.
      </p>
    </div>
  `;
